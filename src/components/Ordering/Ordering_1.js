        ...
        OrderDataService.create(data)
          .then(response => {
            setOrder({
              ...
              offered_by: response.data.offered_by,
      ...
      <ReactBootStrap.Container className="top-space">
        <div className="bg-display" id="order1">
          <ReactBootStrap.Row className="justify-content-md-center">
            <ReactBootStrap.Col>
              <h3>1. Who do you wish to give this gift to?</h3>
            </ReactBootStrap.Col>
          </ReactBootStrap.Row>
          <ReactBootStrap.Row>
        ...
        <div className="bg-display" id="order5">
          ...
          <ReactBootStrap.Row sm={1} md={6}>
            <a onClick={hide5}>
              <div
                style={{ marginTop: "8px", paddingRight: "5px" }}
                className="bg-display-button"
              >
                <ReactBootStrap.Col>
                  <p>No</p>
                </ReactBootStrap.Col>
          ...
          >
            <Form.Row className="justify-content-md-center">
              <Form.Group as={Col} xs={7} controlId="formGridFirstName">
                ...
                <Form.Control type="text" placeholder="First Name" value={order.first_name} onChange={handleInputChange} name="first_name"/>
              </Form.Group>

              <Form.Group as={Col} controlId="formGridLastName">
                <Form.Label>Beneficiary Last Name</Form.Label>
                <Form.Control type="text" placeholder="Last Name" value={order.last_name} onChange={handleInputChange} name="last_name"/>
              </Form.Group>
            </Form.Row>
            ...
            <div className="w-50 d-inline-block">
              <Form.Group controlId="formGridDate">
                ...
                <Form.Control type="date" placeholder="1234 Main St" value={order.date} onChange={handleInputChange} name="date"/>
              </Form.Group>
              ...
              <Form.Group controlId="formGridTime">
                ...
                <Form.Control type="time" placeholder="1234 Main St" value={order.time} onChange={handleInputChange} name="time"/>
              </Form.Group>

              <Form.Group controlId="formGridHost">
                <Form.Label>Offered by</Form.Label>
                <Form.Control type="text" placeholder="Answer here" value={order.offered_by} onChange={handleInputChange} name="offered_by"/>
              </Form.Group>
              ...
              <Form.Group controlId="formGridEmail">
                ...
                <Form.Control placeholder="yourname@gmail.com" value={order.email} onChange={handleInputChange} name="email"/>
              </Form.Group>

              <Form.Group controlId="formGridAddress1">
                <Form.Label>Address 1</Form.Label>
                <Form.Control placeholder="1234 Main St" value={order.address1} onChange={handleInputChange} name="address1"/>
              </Form.Group>

              <Form.Group controlId="formGridAddress2">
                <Form.Label>Address 2</Form.Label>
                <Form.Control placeholder="Apartment, studio, or floor" value={order.address2} onChange={handleInputChange} name="address2"/>
              </Form.Group>
            </div>
            <Form.Row>
              <Form.Group as={Col} controlId="formGridCity">
                <Form.Label>City</Form.Label>
                <Form.Control value={order.city} onChange={handleInputChange} name="city"/>
              </Form.Group>

              <Form.Group as={Col} controlId="formGridState">
                <Form.Label>State</Form.Label>
                <Form.Control as="select" defaultValue="Choose..." value={order.state} onChange={handleInputChange} name="state">
              ...
              <Form.Group as={Col} controlId="formGridZip">
                ...
                <Form.Control value={order.zip} onChange={handleInputChange} name="zip"/>
              </Form.Group>
            </Form.Row>
            ...
            <a href={process.env.PUBLIC_URL + "/#/"}>
              <ReactBootStrap.Button onClick={saveOrder} variant="danger" className="button">
                Submit
              </ReactBootStrap.Button>
            </a>
          </Form>
