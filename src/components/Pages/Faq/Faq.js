    ...
    render() {
        ...
        return (
            ...
            <ReactBootStrap.Row className="justify-content-md-center" >
                ...
                <i id="explanation"><p>Here are some questions collected here and there by our 
                musicians and our team about dans l'Jardin and how it works: </p></i>
                       </ReactBootStrap.Col>
                       </ReactBootStrap.Row>
            ...
            <ReactBootStrap.Row className="justify-content-md-center">
                ...
                <ReactBootStrap.Col className="fontcol" style={{marginLeft:'10px', marginTop:'1px', textAlign:'left'}}><p>The services in the Garden are indicated for an audience of 1 to approx. 14 people,
                     ...
                     background entertainment, for official events or for wedding aperitifs.
                      ...
                      his future wife and his bridesmaids on the day of the wedding dress fitting, great!</p></ReactBootStrap.Col>
                      </div>
               </ReactBootStrap.Col>
            </ReactBootStrap.Row>
            ...
            <ReactBootStrap.Row className="justify-content-md-center">
                ...
                3% - Online payment commission  </p></ReactBootStrap.Col>
               </ReactBootStrap.Col>
            </ReactBootStrap.Row>
            ...
            <ReactBootStrap.Row className="justify-content-md-center" >
                ...
                It has so far always been possible to find one and we will do everything possible to keep it that way.</p></ReactBootStrap.Col>
               </ReactBootStrap.Col>
            </ReactBootStrap.Row>
                ...
                <ReactBootStrap.Col className="fontcol" style={{marginLeft:'10px', marginTop:'1px'}} id="high"><p>
                    The platform is dependent on the availability and location of the artists.
                     All musicians from dans l'Jardin have their own musical activities outside of the platform.
                      ...
                      date in real time and therefore to offer it. </p> </ReactBootStrap.Col>
               </ReactBootStrap.Col>
            </ReactBootStrap.Row>
            ...
            <ReactBootStrap.Row className="justify-content-md-center" >
                ...
                <ReactBootStrap.Col className="fontcol" style={{marginLeft:'10px', marginTop:'1px'}} id="high"><p>
                 ...
                 It is certainly a challenge, but we believe that everyone has the right to listen to music.</p>
                Our musical field of action is based throughout French-speaking Switzerland.</ReactBootStrap.Col>
               </ReactBootStrap.Col>
            </ReactBootStrap.Row>
            ...
            <ReactBootStrap.Row className="justify-content-md-center" >
                ...
                They will be all the more grateful to you in these difficult times in the cultural field.
                 ...
                 is between you and the artist.</p></ReactBootStrap.Col>
               </ReactBootStrap.Col>
            </ReactBootStrap.Row>
            ...
            <ReactBootStrap.Row className="justify-content-md-center" >
                ...
                We insist on the fact that it is important, out of respect for the artists, not to change,
                 unless there is a major problem, the schedule agreed with the artist. </p></ReactBootStrap.Col>
               </ReactBootStrap.Col>
            </ReactBootStrap.Row>
            ...
            <ReactBootStrap.Row className="justify-content-md-center" >
                ...
                <ReactBootStrap.Col className="fontcol" id="high" style={{marginLeft:'5px',fontSize:'21px'}}><p>
