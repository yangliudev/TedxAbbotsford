                            ...
                            <ReactBootStrap.Col md={{ span: 8, offset: 2 }} >
                                ...
                                <ReactBootStrap.Row >
                                    ...
                                    <ReactBootStrap.Col md={{ span: 4 }}>
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" id="defaultGroupExample1" name="groupOfDefaultRadios" onClick={HideTextArea, (e) => { setTraining("master"); }} />
                                            <label class="custom-control-label" for="defaultGroupExample1">Master</label>
                                        </div>

                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" id="defaultGroupExample2" name="groupOfDefaultRadios" onClick={HideTextArea, (e) => { setTraining("in school"); }} />
                                    ...
                                    <ReactBootStrap.Col md={{ span: 6 }} >
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" id="defaultGroupExample3" name="groupOfDefaultRadios" onClick={HideTextArea,(e) => { setTraining("Bachelor"); }} />
                                ...
                                <ReactBootStrap.Row>
                                    <ReactBootStrap.Col md={{ span: 3 }} >
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="style0" onChange={(e) => { setInstrument("voice"); }} />
                                            <label class="custom-control-label" for="style0">Voice</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="style1" onChange={(e) => { setInstrument("piano"); }} />
                                            <label class="custom-control-label" for="style1">Piano</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="style2" onChange={(e) => { setInstrument("harp"); }} />
                                ...
                                <ReactBootStrap.Row>
                                    ...
                                    <ReactBootStrap.Col >
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="solo" onChange={(e) => { setGroup("solo"); }}/>
                                            <label class="custom-control-label" for="solo">solo</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="duet" onChange={(e) => { setGroup("duet"); }}/>
