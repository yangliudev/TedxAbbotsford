...
function MusicianRequests() {
  ...
  return (
    <div style={{marginTop:"30px"}}>
            <MuiThemeProvider theme={getMuiTheme()} class="requestsTable">

            <MUIDataTable title={"Musician Requests"} data={data} columns={columns} options={options} class="requestsTable"/>
            </MuiThemeProvider>
            </div>
  );
}
